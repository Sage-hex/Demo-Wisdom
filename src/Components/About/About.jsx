  ...
  return (
    <section className="w-full h-[200vh] flex items-center justify-center border-4 border-black rounded-t-[300px] bg-blue-500">
      <div className="w-[85%] h-5/6 bg-red-500 rounded-t-[150px] ">
        <div className="md:flex items-center justify-center p-[5rem] gap-[10rem] h-[45%] rounded-t-[150px] border-2 border-black">
          <div className="w-[50%]  flex items-center justify-center rounded-tl-[100px] p-[1rem] bg-white border-2 border-black">
            <img src={AboutImage} alt="about-left-image" />
          </div>

          <div>
            <h1 className="bg-green-500">About us</h1>
