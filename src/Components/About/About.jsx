...
const About = () => {
  return (
    <section className="w-full h-auto md:h-[200vh] lg:h-[200vh] flex items-center md:items-end justify-center border-2 border-black rounded-t-[50px] md:rounded-t-[150px]  lg:rounded-t-[200px] bg-blue-500">
      <div className="flex flex-col justify-between gap-[3rem] md:gap-[8rem] lg:gap-[0] items-center  w-full md:w-[85%]  h-5/6  lg:rounded-t-[150px]">
      
      <div className="flex flex-col lg:flex-row items-center justify-center rounded-t-[0px] gap-[2.5rem] xl:gap-[3rem] w-[95%] h-[30%] md:w-[100%] h-2/5 xl:w-[100%] lg:rounded-t-[150px] mt-[4rem] md:mt-0">
          <div className="w-full h-[50%] md:h-[60%] lg:w-[40%]  lg:h-[100%]  flex items-center justify-center rounded-t-[50px] md:rounded-t-[50px] lg:rounded-t-[0]    lg:rounded-tl-[150px] p-[1rem] bg-customWhite ">
        ...
        <div className="flex flex-col items-center justify-start gap-[2rem]  lg-w-[95%] h-2/4">
            ...
            <div className=" w-full h-auto md:h-3/5 flex flex-col md:flex-row items-end justify-center gap-8 ">
