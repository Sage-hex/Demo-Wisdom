    ...
    <section className='w-full pt-[10vh] bg-white min-h-screen flex justify-center items-center'>
      <div className=" w-5/6 h-full flex flex-col justify-between pt-56 sm:pt-25 md:pt-40 gap-14 items-center bg-grid-large">
        ...
        <div className='w-full flex flex-col items-center justify-center mb-8'>
          ...
          <h1 className="text-[10rem] sm:text-3xl md:text-7xl lg:text-[5rem] font-bold text-center text-customPink">
            Fuel your passion!
          </h1>
        </div>
        ...
        <div className='w-full flex flex-col md:flex-row items-center justify-between'>
          ...
          <div className='md-w-[60%] md:w-1/2 text-center px-4 mb-6 md:mb-0 flex flex-col items-center justify-center'>
            <h2 className="capitalize md:text-5xl sm:text-2xl font-normal mb-4 leading-[3.2rem]">
              Your creativity <br /> deserves to be <br /> rewarded
            </h2>
            <p className='text-gray-700 mb-6 mt-14 font-thin text-lg font-[nutino]'>
